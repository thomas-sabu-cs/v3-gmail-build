...
export function EmailList({ emails, currentUserId }: { emails: EmailRow[]; currentUserId: string }) {
  ...
  if (emails.length === 0) {
    return <p className="rounded-lg bg-white p-6 text-sm text-gray-600">No emails found in this mailbox.</p>;
  }
